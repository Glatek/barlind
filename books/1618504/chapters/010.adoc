...
Liåste vi röra på oss, annars hinna vi för litet i dag.
...
tre procert. Det vill säga 100 kilo karp minskas till 97 kilo.

— Här hade jag i vintras 6,000 fiskar.

— Som ni ser har jag ankor på dammen nu. Det är dubbel
